...
- (void)showImage
{
    if (_photo.firstShow) { // 首次显示
        ...
        if (_photo.assets) {
//            CGImageRef ref = [[_photo.assets defaultRepresentation]fullScreenImage];
...
//            _imageView.image = image;
            ...
            [[PHImageManager defaultManager] requestImageForAsset:_photo.assets targetSize:CGSizeMake(2000, 2000) contentMode:PHImageContentModeAspectFit options:options resultHandler:^(UIImage *result, NSDictionary *info) {
...
- (void)scrollViewDidZoom:(UIScrollView *)scrollView NS_AVAILABLE_IOS(3_2)
{
    ...
    CGFloat boundsWidth = boundsSize.width;
    CGFloat boundsHeight = boundsSize.height;
    if(self.contentSize.width > boundsWidth && self.contentSize.height > boundsHeight)
    {
