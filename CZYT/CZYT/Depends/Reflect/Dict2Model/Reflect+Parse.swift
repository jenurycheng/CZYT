...
//                        print("==========\(type.realType),\(type.isOptional)")
                        ...
                        }else if dict[key] != nil && !dict[key]!.isEqual(NSNull()){
                        ...
                        if dictValue != nil && !dictValue!.isEqual(NSNull()){ //字典中有模型
                    ...
                    if let res = type.isAggregate(){
                        ...
                        if dict[key] != nil && !dict[key]!.isEqual(NSNull())
                        {
    ...
    func mappingDict() -> [String: String]? {return ["descript":"description"]}
