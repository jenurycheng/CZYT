...
//                                 action:@selector(cancelAction)];
    ...
    UIBarButtonItem *rightButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"back_normal"] style:UIBarButtonItemStylePlain target:self action:@selector(backButtonAction)];
    self.navigationItem.rightBarButtonItem = rightButtonItem;
    UIBarButtonItem *right = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStylePlain target:self action:@selector(cancelAction)];
...
//    [self browserPhotoAsstes:self.assetsArray pageIndex:indexPath.row];
    DNAssetsViewCell *cell = (DNAssetsViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
    [cell checkButtonAction:cell.checkButton];
}
