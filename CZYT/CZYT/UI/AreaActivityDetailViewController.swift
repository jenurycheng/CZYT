//
//  AreaActivityDetailViewController.swift
//  CZYT
//
...
class AreaActivityDetailViewController: BasePortraitViewController {
    ...
    {
        self.view.showHud()
        dataSource.getAreaActivityDetail(id, success: { (result) in
            self.updateView()
            self.view.dismiss()
        }) { (error) in
            self.view.dismiss()
...
extension AreaActivityDetailViewController : UIWebViewDelegate
{
